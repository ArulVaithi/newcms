...
$table_en = 'mst_employeescorner_en';
$table_hi = 'mst_employeescorner_hi';
$table_ta = 'mst_employeescorner_ta';
...
<head>
    <title>NIOT - Employees Corner</title>
                    ...
                    <div class="col-lg-10">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#!"> NIOT Staff</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Employees Corner</a>
                                </li>
                            </ol>
                        </div>
                    </div>
...
<![endif]-->
    ...
    <script>
        ...
        var label = {
            "en_label": {
                "header": "Employees Corner",
                "editHeader": "Edit Employees Corner",
                "title": 'Title',
                "date": "Dated On",
                "file": "File (PDF only)",
                "lang": "en",
            ...
            "hi_label": {
                "header": "कर्मचारी कॉर्नर (Employees Corner)",
                "editHeader": "प्रेस विज्ञप्ति संपादित करें (Edit Employees Corner)",
            ...
            "ta_label": {
                "header": "பணியாளர்கள் கார்னர் (Employees Corner)",
                "editHeader": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Employees Corner)",
                "title": 'தலைப்பு (Employees Corner)',
        ...
        function tabs(val) {
            ...
            var tabHeader = {
                "en": "Employees Corner",
                "hi": "प्रेस विज्ञप्ति (Employees Corner)",
                "ta": "பத்திரிக்கை செய்தி (Employees Corner)"
            }
            $('#getLang').text(val);
            if (val == 'en') {
        ...
        function editBtn(id, datatype) {
            ...
            var editLabel = {
                "en_label": {
                    "header": "Edit Employees Corner",
                    "preview": "Preview Employees Corner",
                    "title": "Edit Title",
                    "date": "Edit Date",
                    "file": "Edit File Name",
                    "url": "Edit Link"
                ...
                "hi_label": {
                    "header": "प्रेस विज्ञप्ति संपादित करें (Edit Employees Corner)",
                    "preview": "पूर्वावलोकन प्रेस विज्ञप्ति (Preview Employees Corner)",
                ...
                "ta_label": {
                    "header": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Employees Corner)",
                    "preview": "முன்னோட்டம் பத்திரிகை வெளியீடு (Preview Employees Corner)",
        ...
        function add_recruitment(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                if ($("#fileCheck").is(':checked')) {
                    ...
                    form_data.append('pagename', 'employeescorner');
                    // form_data.append('title ', title);   
                    data = form_data;
                    ...
                    $.ajax({
                        ...
                        contentType: false,
                        processData: false,
                        url: "webservice/add_employeescorner.php",
                        data: data,
                        beforeSend: function() {
        ...
        function editFunction() {
            ...
            if ($('#edit-demo-form').parsley().validate() != true) {
                ...
                editform_data.append('', modalDate);
