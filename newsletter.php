...
$table_en = 'mst_newsletter_en';
$table_hi = 'mst_newsletter_hi';
$table_ta = 'mst_newsletter_ta';
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center" style="border-radius:0px;padding-bottom:0px;background-color:#d3d3d3;">
                        <h4 style="color:#111">News Letter</h4>
                    </div>
                    <div class="col-lg-12">
                        <!-- Row start -->
                        <div class="row">
...
<![endif]-->
    ...
    <script>
        ...
        function editBtn(id, datatype) {
            ...
            var editLabel = {
                "en_label": {
                    "header": "Edit News Letter",
                    "preview": "Preview News Letter",
                    "title": "Edit Title",
                    "date": "Edit Date",
                    "file": "Edit File Name",
                    "url": "Edit Link"
        ...
        function add_recruitment(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                if ($("#fileCheck").is(':checked')) {
                    ...
                    form_data.append('pagename', 'newsletter');
                    // form_data.append('title ', title);
                    data = form_data;
