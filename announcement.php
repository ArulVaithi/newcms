...
$table_en = 'mst_newsannouncement_en';
$table_hi = 'mst_newsannouncement_hi';
$table_ta = 'mst_newsannouncement_ta';
...
<head>
    <title>NIOT - news Announcement</title>
                    ...
                    <div class="col-lg-10">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">News Announcement</a>
                                </li>
                            </ol>
                        </div>
...
">
                        <h4 style="color:#111">News Announcement</h4>
                    </div>
                    <div class="col-lg-12">
                        <!-- Row start -->
                        <div class="row">
                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="tab-content tabs">
                                                                ...
                                                                <table class="tbl-en-draft" class="table table-borderd" width="100%">
                                                                    <thead style="color:#fff;width:100%;background:#40c4ff">
                                                                        <tr>
                                                                            ...
                                                                            <th>क्रमांक (S.No)</th>
                                                                            <th  style="width:30%;">शीर्षक (Title)</th>
                                                                            
                                                                            <th  style="width:10%;">फ़ाइल का नाम (File Name)</th>
                                                                            <!-- <th>संपर्क (Link)</th> -->
                                                                            <th>दिनांक (Date)</th>
                                                                            <th>स्थिति (Status)</th>
                                                                ...
                                                                <table class="tbl-en-draft" class="table table-borderd" width="100%">
                                                                    <thead style="color:#fff;width:100%;background:#40c4ff">
                                                                        <tr>
                                                                            ...
                                                                            <th>வ.எண் (S.No)</th>
                                                                            <th style="width:30%;">தலைப்பு (Title)</th>
                                                                      
                                                                            <th style="width:10%;" >கோப்பு பெயர் (File Name)</th>
                                                                            <!-- <th>இணைப்பு (Link)</th> -->
                                                                            <th  >தேதி (Date)</th>
                                                                            <th>நிலை (Status)</th>
                                                    ...
                                                    <div class="tab-pane" id="messages11" role="tabpanel">
                                                        <h3 class="text-center"><?php echo $techrow_ta['title']; ?></h3>
                                                        <div class="data-table-list-En-draft">
                                                            <!-- <h2 class="text-center">समाचार / घोषणा (News/Announcement)</h2> -->
                                                            <div class="table-responsive">
                                                                <table id="tbl-ta-draft" class="table table-borderd" width="100%">
                                                                    <button class="btn btn-success notika-btn-success pull-left" data-toggle="modal" data-target="#addModal" style="margin-right:20px;" onclick="addNew('ta');"><i class="fa fa-plus"> </i> புதிதாக சேர்க்கவும் (Add New)</button>
                                                                    <h3 class="text-center" style="padding-right:110px;">வரைவு பொருட்கள் (Draft Items)</h3>
                                                                    <thead bgcolor="#87CDF6 " style="color:#fff;">
                                                                        <tr>
                                                                            <!-- <th><input type="checkbox" class="" id='checkallusers' onclick="checkAll(id);"> All
                                                                    </th> -->
                                                                            <th>வ.எண் (S.No)</th>
                               ...
                               <td>' .
                                    ...
                                    <td id="tblTaFileName' .
                                                                        ...
                                                                        <td>' .
                                                                                ...
                                                                                '</td>  
                                                                        <td ><b style="color:#F535AA;font-size:125%;">Draft</b></td>
                                                                        <td>
                                                                    <div class="bootstrap-select fm-cmp-mg" >
                                                                        <select class="select2" id="sltTaStatus' .
                                                                                $row['newsid'] .
                                                                                '" data-live-search="true" onchange="statusChange(' .
                                                                                $row['newsid'] .
                                                                                ',this.value);">
                                    ...
                                    <td> &nbsp;&nbsp;<button type="button" class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#editModal"  title="Edit Here" onclick="editBtn(' .
                                                                                $row['newsid'] .
                                                                                ',\'' . $row['status'] . '\');"><i class="fa fa-edit"></i></button> &nbsp;&nbsp;<button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"  onclick="editBtn(' .
                                                                                $row['newsid'] .
                                                                                ',\'' . $row['status'] . '\');"><i class="fa fa-eye"></i></button> </td>
                               </tr>  
                               ';
                                                                        }
                                                                        ?>
                                                ...
                                                <td>63</td>
                                                <td>2011/07/25</td>
                                                <td> <button c  lass="btn btn-info notika-btn-info" data-toggle="modal" data-target="#addModal" style="margin-right:20px;"><i class="fa fa-edit"></i> Edit</button><button class="btn btn-danger notika-btn-danger"><i class="fa fa-trash"></i> Delete</button></td>
                                            </tr> -->
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <h2>Filter Options</h2>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        <h3 class="text-center">வெளியிடப்பட்ட பொருட்கள் (Published Items)</h3>
                                                                    </div>
                                                                    <table id="tbl-ta-published" class="table table-striped" width="100%">
                                                                        <thead bgcolor="#8CE68C " style="color:#fff;">
                                                                            <tr>
                                                                                <!-- <th><input type="checkbox" class="" id='checkallusers' onclick="checkAll(id);"> All
                                                                    </th> -->
                                                                                <th>வ.எண் (S.No)</th>
                                                                                ...
                                                                                <th>கோப்பு பெயர் (File Name)</th>
                                                                                <!-- <th>இணைப்பு (Link)</th> -->
                                                                                <th>உருவாக்கப்பட்ட தேதி(Created Date)</th>
                                                                                <th>நிலை (Status)</th>
                                                                                <th>நிலை மாற்றம் (Status Change)</th>
                                                                                <th>செயல் (Action)</th>
                                                                            </tr>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            while (
                                                                                ...
                                                                                $statusArray['id'] =
                                                                                    $row['newsid'];
                                                                                $statusChange[] = $statusArray;
                                                                                array_push($statuslang["ta"], array("status" =>   $row['status'], "id" => $row['newsid']));
                                                                                echo '  
                               <tr>  
                               <td>' .
                                                                                    ++$i .
                               ...
                               ';
                                                ...
                                                <td>63</td>
                                                <td>2011/07/25</td>
                                                <td> <button class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#addModal" style="margin-right:20px;"><i class="fa fa-edit"></i> Edit</button><button class="btn btn-danger notika-btn-danger"><i class="fa fa-trash"></i> Delete</button></td>
                                            </tr> -->
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                ...
                <div class="modal-body" style="padding-top:10px;">
                    <form id="demo-form" data-parsley-validate="">
                        <div class="form-group">
                            <label for="title"><span class="enaddTitle"> </span><span class="mandatory"> *</span></label>
                            <input type="text" class="form-control" id="txtTitle" name="title" placeholder="Enter English Title" required="" data-parsley-length="[2, 5000]" data-parsley-group="block1" data-parsley-trigger="change">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <!-- <input type="text" name="daterange" readonly class="form-control" value="01/01/2015 - 01/31/2015" /> -->
    ...
    <script>
        ...
        var label = {
            "en_label": {
                ...
                "editHeader": "Edit News / Announcements",
            ...
            "hi_label": {
                "header": "समाचार / घोषणाएं (News / Announcements)",
                "editHeader": "समाचार / घोषणाएँ संपादित करें",
                "title": 'शीर्षक (Title)',
                "date": "दिनांक (Date)",
            ...
            "ta_label": {
                "header": "செய்திகள் / அறிவிப்புகள் (News / Announcements)",
                "editHeader": "செய்திகள் / அறிவிப்புகளைத் திருத்தவும்",
                "title": 'தலைப்பு (Title)',
                "date": "தேதி (Date)",
        ...
        function tabs(val) {
            ...
            var tabHeader = {
                ...
                "hi": "समाचार / घोषणाएं (News / Announcements)",
                "ta": "செய்திகள் / அறிவிப்புகள் (News / Announcements)"
            }
            $('#getLang').text(val);
            if (val == 'en') {
        ...
        function addNew(lang) {
            ...
            if (lang == 'en') {
                ...
                $('.enaddTitle').text(label.en_label.entitle);
                $('.hiaddTitle').text(label.en_label.hititle);
                $('.taaddTitle').text(label.en_label.tatitle);
        ...
        function editBtn(id, datatype) {
            ...
            var editLabel = {
                "en_label": {
                    "header": "Edit News / Announcements",
                    "preview": "Preview News / Announcements",
                    "title": "Edit Title",
                    "date": "Edit Date",
                    "file": "Edit File Name",
                    "url": "Edit Link"
                ...
                "hi_label": {
                    "header": "समाचार / घोषणाएँ संपादित करें (Edit News / Announcements)",
                    "preview": "पूर्वावलोकन समाचार / घोषणाएँ (Preview News / Announcements)",
                ...
                "ta_label": {
                    "header": "செய்திகள் / அறிவிப்புகளைத் திருத்தவும் (Edit News / Announcements)",
                    "preview": "முன்னோட்ட செய்திகள் / அறிவிப்புகள் (Preview News / Announcements)",
        ...
        function add_recruitment(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                if ($("#fileCheck").is(':checked')) {
                    ...
                    form_data.append('pagename', 'newsannouncement');
                    // form_data.append('title ', title);
                    data = form_data;
        ...
        function statusAppend() {
            ...
            if (tabLang == 'en') {
                ...
                for (i = 0; i < arraylength; i++) {
                    console.log(statusChange.en[i].status);
