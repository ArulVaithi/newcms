                                                                        ...
                                                                        <table class="tbl-en-draft" class="table table-borderd ">
                                                                            <thead id="thead" style="color:#fff;width:100%;background:#40c4ff" class="text-center">
                                                                                <tr>
                                                                                    ...
                                                                                    <th class="text-center">Advertisement File</th>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <!-- <tr>
                                                                                    ...
                                                                                    <td>Advertisement File</td> -->
                                                                                <!-- <td>Announcements Title</td>
                                                                                    <td>Announcements File</td>
                                                                                    <td> Date</td>
                                                                                    <td> Online Applications Date</td>
                                                                                    <td> Date for Receipt</td>
                                                                                    <td> Hard Copy Date</td> -->
                                                                                <!-- <td> status</td>
                                                                                    <td style="width:30%;"> <select class="js-example-responsive  select2" id="sltTaStatus<?php echo $row['rec_id'] ?>
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['rec_id'] ?>,this.value);">
                                                                                    ...
                                                                                    <td> -->
                                                                                <!-- <button type="button" class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#addannounceModal" onclick="editBtn(' <?php echo $row['rec_id'] ?> ','<?php echo $row['status'] ?>');" title="Add Announcements"><i class="fa fa-plus"></i> Add Announce</button>
                                                                                        &nbsp;&nbsp;<br> -->
                                                                                <!-- <a type="submit" class="btn btn-info notika-btn-info" href="niot_recruitment_edit.php" onclick="editBtn(' <?php echo $row['rec_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></a> -->
                                                                                <!-- &nbsp;&nbsp;
                                                                                        <button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"><i class="fa fa-eye"></i></button></td> -->
                                                                                ...
                                                                                ?>
                                                                                  ...
                                                                                  '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['rec_id'] ?>,this.value);">
                                                                                        ...
                                                                                        <td id="tblEnTitle" <?php echo $row['rec_id']  ?>><a type="submit" class="btn btn-info notika-btn-info" href="niot_recruitment_edit.php?link=<?php echo base64_encode($row['rec_id']) ?>" title="Edit Here"><i class="fa fa-edit"></i></a>
...
<![endif]-->
                    ...
                    <form id="demo-form" data-parsley-validate="">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="title">Application Title<span class="mandatory"> *</span></label>
                                        <textarea type="text" class="form-control" id="addtxtannounce" name="title" placeholder="Enter Title" required="" data-parsley-length="[2, 5000]" data-parsley-group="block1" data-parsley-trigger="change"></textarea>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="email1">Application File<span class="mandatory"> *</span></label>
    ...
    <div class="modal animated fade modal-popout-bg" id="addannounceModal" role="dialog" tabindex="-1" data-keyboard="true" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style=" border-bottom: 1px solid #e8e8e8;">
                    <div class="col-lg-12" style="padding-bottom:10px;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="title"><span class="addTitle"> </span><span class="mandatory"> *</span></label>
                                        <input type="text" class="form-control" id="txtTitle1" name="title" placeholder="Enter Title" required="" data-parsley-length="[2, 200]" data-parsley-group="block1" data-parsley-trigger="change">
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="email1"><span id="advertisementlabel"> </span><span class="mandatory"> *</span></label>
                                        <input type="file" class="form-control input-sm" id="ad_file1" accept="application/pdf" name="file" data-parsley-trigger="change">
                                    </div>
                                    <label for="advertisment">
                                        <a style="color:#40c4ff">Add More File <i class="fa fa-plus"></i></a>

                                    </label>
                                    <input type="file" name="file1[]" accept=".pdf" id="advertisment1" style="visibility: hidden; position: absolute;" multiple />
                                    <p id="files-area1">
                                        <span id="filesList">
                                            <span id="files-names"></span>
                                        </span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="title">Application Title<span class="mandatory"> *</span></label>
                                        <textarea type="text" class="form-control" id="txtannounce11" name="title" placeholder="Enter Title" required="" data-parsley-length="[2, 5000]" data-parsley-group="block1" data-parsley-trigger="change"></textarea>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="email1">Application File<span class="mandatory"> *</span></label>
                                        <input type="file" class="form-control input-sm" id="app_file1" accept="application/pdf" name="appfile" data-parsley-trigger="change">
                                    </div>
                                    <label for="application">
                                        <a style="color:#40c4ff">Add More File <i class="fa fa-plus"></i></a>

                                    </label>
                                    <input type="file" name="appfile1[]" accept=".pdf" id="app_file11" style="visibility: hidden; position: absolute;" multiple />
                                    <p id="files-area">
                                        <span id="applicationList1">
                                            <span id="application-names1"></span>
                                        </span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date ">
                                            <span class="input-group-addon " data-provide="datepicker"> <span class="fa fa-calendar"></span></span>
                                            <input type="text" class="form-control" readonly id="endDate1" name="date" value='' placeholder="Enter Date" required="" data-parsley-trigger="change">
                                        </div>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date ">
                                            <span class="input-group-addon " data-provide="datepicker"> <span class="fa fa-calendar"></span></span>
                                            <input type="text" class="form-control" readonly id="onlinedate1" name="date" value='' placeholder="Enter Date" required="" data-parsley-trigger="change">
                                        </div>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date ">
                                            <span class="input-group-addon " data-provide="datepicker"> <span class="fa fa-calendar"></span></span>
                                            <input type="text" class="form-control" readonly id="receiptdate1" name="date" value='' placeholder="Enter Date" required="" data-parsley-trigger="change">
                                        </div>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date ">
                                            <span class="input-group-addon " data-provide="datepicker"> <span class="fa fa-calendar"></span></span>
                                            <input type="text" class="form-control" readonly id="hardcopydate1" name="date" value='' placeholder="Enter Date" required="" data-parsley-trigger="change">
                                        </div>
                                        <!-- <small id="emailHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                                    </div>
                                </div>
    ...
    <script>
        ...
        function addNew(lang) {
            ...
            if (lang == 'en') {
                ...
                $('#applicationfile').text(label.en_label.applicationfile);
                $('#addapplicationform').text(label.en_label.application);
        ...
        function add_Recruitments(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                link = $('#add_link').val();
                announcements = $('#addtxtannounce').val();
