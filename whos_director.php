...
$dir_en_query = "select  *  from mst_whoswho_en where designation='niot_director' and contents <> '' limit 1";
...
$dir_hi_query = "select  *  from mst_whoswho_hi where designation='niot_director' and contents <> '' limit 1";
...
$dir_ta_query = "select  *  from mst_whoswho_ta where designation='niot_director' and contents <> '' limit 1";
                    ...
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Director, NIOT</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <div class="tab-content tabs">
                                                    <div class="tab-pane active" id="home1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">Director, NIOT</h3>
                                                            ...
                                                            <?php if ($resultdirector_en_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setdirector_en">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savedirector_en"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('director_en','english')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            ?>
                                                                ...
                                                                <form data-parsley-validate="" id="putdirector_en">
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                        <textarea class="tinymce" id="editdirector_en"><?php echo $row1['contents'] ?></textarea>
                                                                        ...
                                                                        <div class="row text-center" style="padding-top:10px;">
                                                                            <button class="btn btn-primary mt-4" type="button" onclick="updateText('director_en','english');"> Update</button>
                                                    ...
                                                    <div class="tab-pane" id="profile1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">निर्देशक (Director, NIOT)</h3>
                                                            <?php if ($resultdirector_hi_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setdirector_hi">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savedirector_hi"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('director_hi','hindi')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            ?>
                                                                <form data-parsley-validate="" id="putdirector_hi">
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                        <textarea class="tinymce" id="editdirector_hi"><?php echo $row2['contents'] ?></textarea>
                                                                        ...
                                                                        <div class="row text-center" style="padding-top:10px;   ">
                                                                            <button class="btn btn-primary mt-4" type="button" onclick="updateText('director_hi','hindi');"> Update</button>
                                                                            <!-- <button class="btn btn-danger mt-4">Close</button> -->
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <div class="tab-pane" id="messages1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">இயக்குனர் (Director, NIOT)</h3>


                                                            <?php if ($resultdirector_ta_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setdirector_ta">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savedirector_ta"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('director_ta','tamil')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    <?php } else {

                                                                    ?>
                                                                        <form data-parsley-validate="" id="putdirector_ta">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                        <div class="form-group">
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                                <textarea class="tinymce" id="editdirector_ta"><?php echo $row3['contents'] ?></textarea>
                                                                                ...
                                                                                <div class="row text-center" style="padding-top:10px;">
                                                                                    <button class="btn btn-primary mt-4" type="button" onclick="updateText('director_ta','tamil');"> Update</button>
                                                                                    <!-- <button class="btn btn-danger mt-4">Close</button> -->
                                                                                </div>
                                                                            </div>
                                                                        </form>
