...
if ($_POST['link'] != "") {
    ...
    $query = "insert into mst_" . $tablename . "_" . $lang . " (title,announce_dt,filename,ad_link,filesize,inserted_by,uploaded_on,updated_on) values('$title','$end_date','','$link','','$sessionId','$currdate','$currdate')";
