...
$table_en = 'mst_pressrelease_en';
$table_hi = 'mst_pressrelease_hi';
$table_ta = 'mst_pressrelease_ta';
...
$statuscheck = "select en.title,en.doc_id,hi.mas_docid as hi_masid, ta.mas_docid as ta_masid, en.filename,en.ad_link,en.announce_dt,en.status from mst_pressrelease_en en
LEFT OUTER  join mst_pressrelease_hi hi on hi.mas_docid=en.doc_id 
LEFT OUTER  join mst_pressrelease_ta ta on ta.mas_docid=en.doc_id  where en.doc_id in (select doc_id from mst_pressrelease_en where status= 'N')  

union all

select en.title,en.doc_id,hi.mas_docid as hi_masid , ta.mas_docid as ta_masid, en.filename,en.ad_link,en.announce_dt,en.status from mst_pressrelease_en en
LEFT OUTER  join mst_pressrelease_hi hi on hi.mas_docid=en.doc_id
LEFT OUTER  join mst_pressrelease_ta ta on ta.mas_docid=en.doc_id  where en.doc_id in (select doc_id from mst_pressrelease_en where status<> 'N')   ";
...
<head>
    <title>NIOT - Press Release</title>
                    ...
                    <div class="col-lg-10">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Press Release</a>
                                </li>
                            </ol>
                        </div>
                                                                        ...
                                                                        <table class="tbl-en-draft" class="table table-borderd ">
                                                                            ...
                                                                            <tbody>
                                                                                <!-- <tr>
                                                                                    ...
                                                                                    <td>files </td>
                                                                                    <td>status </td>
                                                                                    <td><select class="select2" id="sltEnStatus<?php echo $row['doc_id'] ?>
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['doc_id'] ?>,this.value);">
                                                                                    ...
                                                                                    <td> <button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['doc_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                            ...
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['doc_id'] ?>,this.value);">
                                                                                        ...
                                                                                        <td id="tblEnTitle" <?php echo $row['doc_id']  ?>><button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['doc_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                                        ...
                                                                                        <?php if (is_null($row['hi_masid'])) { ?>
                                                                                            <td><button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#addModal" onclick="addNew('hi',<?php echo $row['doc_id'] ?>);"><i class="fa fa-plus"></i> Add </button> </td>
                                                                                        <?php } else {
                                                                                        ?>
                                                                                            <td id="tblEnTitle" <?php echo $row['doc_id']  ?>><button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['doc_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                                                &nbsp;&nbsp;<button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"><i class="fa fa-eye"></i></button>
                                                                                        ...
                                                                                        <?php }
                                                                                        ?>
                                                                                        <?php if (is_null($row['ta_masid'])) { ?>
                                                                                            <td><button type="button" class="btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#addModal" onclick="addNew('ta',<?php echo $row['doc_id'] ?>);"><i class="fa fa-plus"></i> Add </button> </td>
                                                                                        <?php } else {
                                                                                        ?>
                                                                                            <td id="tblEnTitle" <?php echo $row['doc_id']  ?>><button type="button" class="btn btn-success notika-btn-success" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['doc_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                                                &nbsp;&nbsp;<button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"><i class="fa fa-eye"></i></button>
...
<![endif]-->
    ...
    <script>
        ...
        var label = {
            ...
            "hi_label": {
                "header": "प्रेस विज्ञप्ति (Press Release)",
                "editHeader": "प्रेस विज्ञप्ति संपादित करें (Edit Press Release)",
            ...
            "ta_label": {
                "header": "பத்திரிக்கை செய்தி (Press Release)",
                "editHeader": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Press Release)",
                "title": 'தலைப்பு (Press Release)',
        ...
        function tabs(val) {
            ...
            var tabHeader = {
                "en": "Press Release",
                "hi": "प्रेस विज्ञप्ति (Press Release)",
                "ta": "பத்திரிக்கை செய்தி (Press Release)"
            }
            $('#getLang').text(val);
            if (val == 'en') {
        ...
        function editBtn(id, datatype) {
            ...
            var editLabel = {
                ...
                "hi_label": {
                    "header": "प्रेस विज्ञप्ति संपादित करें (Edit Press Release)",
                    "preview": "पूर्वावलोकन प्रेस विज्ञप्ति (Preview Press Release)",
                ...
                "ta_label": {
                    "header": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Press Release)",
                    "preview": "முன்னோட்டம் பத்திரிகை வெளியீடு (Preview Press Release)",
        ...
        function add_recruitment(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                if ($("#fileCheck").is(':checked')) {
                    ...
                    form_data.append('pagename', 'pressrelease');
                    form_data.append('mas_id', mas_docid);
                    data = form_data;
                    ...
                    $.ajax({
                        ...
                        contentType: false,
                        processData: false,
                        url: "webservice/add_press_release.php",
                        data: data,
                        beforeSend: function() {
