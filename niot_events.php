...
$table_en = 'mst_events_en';
$table_hi = 'mst_events_hi';
$table_ta = 'mst_events_ta';
// $connect = pg_connect("localhost", "root", "", "testing");
// $draftEn = "SELECT * FROM $table_en WHERE inserted_by='$sessionId'   AND status='N' ORDER BY events_id desc";
                                                                ...
                                                                <div class="data-table-list-En-draft">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="tbl-en-draft" class="table table-borderd ">
                                                                            <thead id="thead" style="color:#fff;width:100%;background:#40c4ff" class="text-center" width="100%">
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                while (
                                                                                    ...
                                                                                    array_push($statuslang["en"], array("status" =>   $row['status'], "id" => $row['events_id']));
                                                                                ?>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td id="tblEnTitle" <?php echo $row['events_id']  ?>>
                                                                                            <?php echo $row['title'] ?>
                                                                                        </td>
                                                                                        <td id="tblEnTitle" <?php echo $row['events_id']  ?>>
                                                                                        ...
                                                                                        <td style="width:0%;" id="tblEnTitle" <?php echo $row['events_id']  ?>>
                                                                                            <?php echo $file ?>
                                                                                        </td>

                                                                                        <td><strong><b id="tblEnStatus<?php echo $row['events_id'] ?>"></b></strong>
                                                                                        </td>
                                                                                        <td>
                                                                                            <select class="select2" id="sltEnStatus<?php echo $row['events_id'] ?>
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['events_id'] ?>,this.value);">
                                                                                        ...
                                                                                        <td id="tblEnTitle" <?php echo $row['events_id']  ?>><button type="button" class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['events_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                ...
                                                                <table class="tbl-en-draft" class="table table-borderd" width="100%">
                                                                    <thead style="color:#fff;width:100%;background:#40c4ff">
                                                                        <tr>
                                                                            ...
                                                                            <th>क्रमांक (S.No)</th>
                                                                            <th class="text-center">शीर्षक (Title)</th>
                                                                            <th>दिनांक (Date)</th>
                                                                            <th>कार्यक्रम का स्थान (Venue)</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while (
                                                                            ...
                                                                            array_push($statuslang["hi"], array("status" =>   $row['status'], "id" => $row['events_id']));
                                                                        ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="width:100%;"  id="tblHiTitle" <?php echo $row['events_id']  ?>>
                                                                                    <?php echo $row['title'] ?>
                                                                                </td>

                                                                               
                                                                                <td  id="tblHiTitle" <?php echo $row['events_id']  ?>>
                                                                                    <?php echo date('d-m-Y ', strtotime($row['announce_dt'])) ?>
                                                                                </td>
                                                                                <td id="tblHiTitle" <?php echo $row['events_id']  ?>>
                                                                                    <?php echo $row['eventvenue'] ?>
                                                                                ...
                                                                                <td><strong><b id="tblHiStatus<?php echo $row['events_id'] ?>"></b></strong>
                                                                                </td>
                                                                                <td>
                                                                                    <select class="js-example-responsive  select2" id="sltHiStatus<?php echo $row['events_id'] ?>
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['events_id'] ?>,this.value);">
                                                                                        <option value="Draft">Draft</option>
                                                                                        <option value="Published">Published</option>
                                                                                        <option value="Archive">Archive</option>
                                                                                ...
                                                                                <td id="tblHiTitle" <?php echo $row['events_id']  ?>><button type="button" class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['events_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                                    &nbsp;&nbsp;<button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"><i class="fa fa-eye"></i></button>
                                                                ...
                                                                <table class="tbl-en-draft" class="table table-borderd" width="100%">
                                                                    <thead style="color:#fff;width:100%;background:#40c4ff">
                                                                        <tr>
                                                                            ...
                                                                            <th>வ.எண் (S.No)</th>
                                                                            <th style="width:100%;">தலைப்பு (Title)</th>
                                                                            <th>தேதி (Date)</th>
                                                                            <th>இடம் (Date)</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while (
                                                                            ...
                                                                            array_push($statuslang["ta"], array("status" =>   $row['status'], "id" => $row['events_id']));
                                                                        ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td id="tblTaTitle" <?php echo $row['events_id']  ?>>
                                                                                    <?php echo $row['title'] ?>
                                                                                </td>
                                                                                ...
                                                                                <td><strong><b id="tblTaStatus<?php echo $row['events_id'] ?>"></b></strong>
                                                                                </td>
                                                                                <td>
                                                                                    <select class="js-example-responsive  select2" id="sltTaStatus<?php echo $row['events_id'] ?>
                                                                            '" data-live-search="true" style="width: 100%" onchange="statusChange( <?php echo  $row['events_id'] ?>,this.value);">
                                                                                        <option value="Draft">Draft</option>
                                                                                        <option value="Published">Published</option>
                                                                                        <option value="Archive">Archive</option>
                                                                                ...
                                                                                <td id="tblTaTitle" <?php echo $row['events_id']  ?>><button type="button" class="btn btn-info notika-btn-info" data-toggle="modal" data-target="#editModal" onclick="editBtn(' <?php echo $row['events_id'] ?> ','<?php echo $row['status'] ?>');" title="Edit Here"><i class="fa fa-edit"></i></button>
                                                                                    &nbsp;&nbsp;<button class="btn btn-success notika-btn-success" title="Preview Here" data-toggle="modal" data-target="#previewModal"><i class="fa fa-eye"></i></button>
...
<![endif]-->
    ...
    <script>
        ...
        var label = {
            ...
            "hi_label": {
                "header": "प्रेस विज्ञप्ति (Events)",
                "editHeader": "प्रेस विज्ञप्ति संपादित करें (Edit Events)",
            ...
            "ta_label": {
                "header": "பத்திரிக்கை செய்தி (Events)",
                "editHeader": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Events)",
                "title": 'தலைப்பு (Events)',
        ...
        function tabs(val) {
            ...
            var tabHeader = {
                "en": "Events",
                "hi": "प्रेस विज्ञप्ति (Events)",
                "ta": "பத்திரிக்கை செய்தி (Events)"
            }
            $('#getLang').text(val);
            if (val == 'en') {
        ...
        function editBtn(id, datatype) {
            ...
            var editLabel = {
                ...
                "hi_label": {
                    "header": "प्रेस विज्ञप्ति संपादित करें (Edit Events)",
                    "preview": "पूर्वावलोकन प्रेस विज्ञप्ति (Preview Events)",
                ...
                "ta_label": {
                    "header": "பத்திரிகை வெளியீட்டைத் திருத்தவும் (Edit Events)",
                    "preview": "முன்னோட்டம் பத்திரிகை வெளியீடு (Preview Events)",
        ...
        function add_Events(value) {
            ...
            if ($('#demo-form').parsley().validate() != true) {
                ...
                var eventtitle, ad_filepath, end_date, eventvenue, description, ad_desc, link, lang;
                eventtitle = $.trim($('#txtevent').val());
                end_date = $('#endDate').val();
                eventvenue = $('#txtvenue').val();
                // eventtitle = $('#txt').val();
