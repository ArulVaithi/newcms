      ...
      <header class="main-header-top hidden-print">
          ...
          <a href="#" class="logo" data-toggle="offcanvas" class="sidebar-toggle"><img class="img-fluid able-logo" style=" z-index: -1; " src="assets/images/niot_logo.png" alt="Theme-logo">
              <!-- <div class="col-lg-9 col-md-4 col-sm-6 col-xs-12 pull-left" style="padding-left:1px;padding-top:2px;padding-bottom:3px;"> -->
          ...
          <nav class="navbar navbar-static-top">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12">
                  ...
                  <h3 style="color:#fff">National Institute Of Ocean Technology</h3>
                  <h5 style="color:#fff"><b>Ministry of Earth Sciences, Government Of India</b></h5>
              </div>
      ...
      <a href="#" class="icon-circle txt-white btn btn-sm btn-primary upgrade-button">
         ...
         <a href="#!" class="drop icon-circle" onclick="javascript:toggleFullScreen()">
            <i class="icon-size-fullscreen"></i>
                      ...
                      <li class="dropdown">
                          <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                              <span><img class="img-circle " src="assets/images/avatar-login1.png" style="width:40px;" alt="User Image"></span>
