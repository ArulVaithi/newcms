...
$dir_en_query = "select  *  from mst_whoswho_en where designation='niot_secretary' and contents <> '' limit 1";

$resultdir_en = pg_query($db, $dir_en_query);
$resultsecretary_en_count = pg_num_rows($resultdir_en);
...
$dir_hi_query = "select  *  from mst_whoswho_hi where designation='niot_secretary' and contents <> '' limit 1";

$resultdir_hi = pg_query($db, $dir_hi_query);
$resultsecretary_hi_count = pg_num_rows($resultdir_hi);

$row2 = pg_fetch_array(
    $resultdir_hi
);

$dir_ta_query = "select  *  from mst_whoswho_ta where designation='niot_secretary' and contents <> '' limit 1";

$resultdir_ta = pg_query($db, $dir_ta_query);
$resultsecretary_ta_count = pg_num_rows($resultdir_ta);
                    ...
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Secretary, MoES</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                ...
                                                <div class="tab-content tabs">
                                                    <div class="tab-pane active" id="home1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">Secretary, MoES</h3>
                                                            ...
                                                            <?php if ($resultsecretary_en_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setsecretary_en">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savesecretary_en"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('secretary_en','english')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            ?>
                                                                ...
                                                                <form data-parsley-validate="" id="putsecretary_en">
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                        <textarea class="tinymce" id="editsecretary_en"><?php echo $row1['contents'] ?></textarea>
                                                                        ...
                                                                        <div class="row text-center" style="padding-top:10px;">
                                                                            <button class="btn btn-primary mt-4" type="button" onclick="updateText('secretary_en','english');"> Update</button>
                                                    ...
                                                    <div class="tab-pane" id="profile1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">सचिव (Secretary, MoES)</h3>
                                                            <?php if ($resultsecretary_hi_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setsecretary_hi">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savesecretary_hi"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('secretary_hi','hindi')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            ...
                                                            ?>
                                                                <form data-parsley-validate="" id="putsecretary_hi">
                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                        <textarea class="tinymce" id="editsecretary_hi"><?php echo $row2['contents'] ?></textarea>
                                                                        ...
                                                                        <div class="row text-center" style="padding-top:10px;   ">
                                                                            <button class="btn btn-primary mt-4" type="button" onclick="updateText('secretary_hi','hindi');"> Update</button>
                                                                            <!-- <button class="btn btn-danger mt-4">Close</button> -->
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                    ...
                                                    <div class="tab-pane" id="messages1" role="tabpanel">
                                                        <div class="col-lg-12" style="padding:10px;background:#eeeeee;border: 2px solid  #eeeeee;border-radius:25px; ">
                                                            <h3 class="text-center">செயலாளர் (Secretary, MoES )</h3>


                                                            <?php if ($resultsecretary_ta_count == 0) {
                                                            ?>
                                                                <form data-parsley-validate="" id="setsecretary_ta">

                                                                    <div class="form-group ">
                                                                        <div class="row">
                                                                            <textarea class="tinymce" id="savesecretary_ta"></textarea>
                                                                            </br>
                                                                            <div class="row text-center">
                                                                                <button class="btn btn-primary mt-4" type="button" onclick="savedata('secretary_ta','tamil')">Submit</button>
                                                                            </div>
                                                                        </div>
                                                                    <?php } else {

                                                                    ?>
                                                                        <form data-parsley-validate="" id="putsecretary_ta">
                                                                            ...
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    <div class="col-lg-12" style="border: 2px solid #041e42;border-radius:25px;">
                                                                                        <div class="form-group">
                                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px;padding-bottom:10px;">
                                                                                                <textarea class="tinymce" id="editsecretary_ta"><?php echo $row3['contents'] ?></textarea>
                                                                                ...
                                                                                <div class="row text-center" style="padding-top:10px;">
                                                                                    <button class="btn btn-primary mt-4" type="button" onclick="updateText('secretary_ta','tamil');"> Update</button>
                                                                                    <!-- <button class="btn btn-danger mt-4">Close</button> -->
                                                                                </div>
                                                                            </div>
                                                                        </form>
